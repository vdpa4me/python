...
if __name__ == '__main__':
    ...
    for file_dic in file_list:
        ...
        with open(write_file, 'w') as f:
            ...
            f.write("##############################################\n")
            f.write("\n")
            f.write("Iteration,CPU0_F,CPU0_E,CPU0_D,CPU0_C,CPU0_B,CPU0_A,G1_MIN,G1_MAX,G1_DIFF,\
            ...
            for i in range(0, len(total_measurment_list)):
                ...
                f.write(iteration+","+str(group1_dic['F'])+","+str(group1_dic['E'])+","+str(group1_dic['D'])+","+str(group1_dic['C'])+","+str(group1_dic['B'])+","+str(group1_dic['A'])+ \
    ...
    with open("TotalReport.csv", 'w') as rf:
        ...
        rf.write("##############################################\n")
        rf.write("\n")
        rf.write("CMB,Iteration,CPU0_F,CPU0_E,CPU0_D,CPU0_C,CPU0_B,CPU0_A,G1_MIN,G1_MAX,G1_DIFF,\
                               ,CPU0_G,CPU0_H,CPU0_I,CPU0_J,CPU0_K,CPU0_L,G2_MIN,G2_MAX,G2_DIFF \n")
        ...
        for i in range(0, len(report_list)):
            ...
            rf.write(str(cmb_num)+","+iteration+","+str(group1_dic['F'])+","+str(group1_dic['E'])+","+str(group1_dic['D'])+","+str(group1_dic['C'])+","+str(group1_dic['B'])+","+str(group1_dic['A'])+ \
                                ","+str(group1_dic['MIN'])+","+str(group1_dic['MAX'])+","+str(group1_dic['DIFF'])+","+ \
                                ","+str(group2_dic['G'])+","+str(group2_dic['H'])+","+str(group2_dic['I'])+","+str(group2_dic['J'])+","+str(group2_dic['K'])+","+str(group2_dic['L'])+ \
                                ","+str(group2_dic['MIN'])+","+str(group2_dic['MAX'])+","+str(group2_dic['DIFF'])+"\n")
        rf.close()
